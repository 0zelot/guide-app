<template>
    <nav>
        <img class="logo m-3" alt="Logo" src="https://nightland.pl/images/logo.png">
        <span class="sidebar-label d-block">System umiejętności mcMMO</span>
...
export default {
    ...
    head() {
        ...
        return {
            title: list[slug] ? `${list[slug].title} | Wikipedia mcMMO` : "Wikipedia mcMMO"
        };
    }
}
</script>